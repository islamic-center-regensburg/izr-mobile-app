      ...
      <Glassy className="p-4 rounded-lg h-full">
        ...
        <View className="flex flex-row gap-2 items-center">
          ...
          <Text
            onPress={() =>
              Linking.openURL(
                `mailto:${t("home-screen.contact-section.description.first-chairman.email")}`,
              )
            }
            className="text-left"
          >
        ...
        <View className="flex flex-row gap-2 items-center">
          ...
          <Text
            onPress={() =>
              Linking.openURL(
                `tel:${t("home-screen.contact-section.description.first-chairman.tel")}`,
              )
            }
            className="text-left"
          >
      ...
      <Glassy className="p-4 rounded-lg h-full">
        ...
        <View className="flex flex-row gap-2 items-center">
          ...
          <Text
            onPress={() =>
              Linking.openURL(
                `mailto:${t("home-screen.contact-section.description.it.email")}`,
              )
            }
            className="text-left"
          >
      ...
      <Glassy className="p-4 rounded-lg h-full">
        ...
        <View className="flex flex-row gap-2 items-center">
          ...
          <Text
            onPress={() =>
              Linking.openURL(
                `mailto:${t("home-screen.contact-section.description.room-reservation.email")}`,
              )
            }
            className="text-left"
          >
